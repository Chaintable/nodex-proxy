...
func NewHandler(ctx context.Context, nodeSelector selector.Strategy, etcdEndpoints []string, keyPrefix string, loadBalancer LoadBalancerWithMirrorMap) (*Handler, error) {
